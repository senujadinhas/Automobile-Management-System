...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        frame_7 = customtkinter.CTkFrame(self.tabview.tab("My Profile"),width=400,height=500,fg_color="transparent")
        frame_7.grid(row=1,padx=(0,25))
        ...
        tree_style.configure('Treeview', background='red')
        ...
        treeview.heading('Vehicle Engine Size', text='V. Engine Size',anchor=W)
    ...
    #---------------------------------------------------------------------------------------
        ...
        p_treeview.place(width=1320, height=700)
    ...
    #------------------------------------------------------------------------------------
        ...
        def change_to_new():
            ...
            if (i_dialog1 == "" or i_dialog1 == " "):
                ...
                try:
                    ...
                    cursor = conn.cursor()
                    cursor.execute("UPDATE user SET pwd=%s WHERE id=%s ",(i_dialog1, ddd))
                    conn.commit()
                    cursor.close()
        ...
        def button_click_event():
            ...
            if (i_dialog == "" or i_dialog == " "):
                ...
                try:
                    conn = connection() 
                    cursor = conn.cursor()
                    cursor.execute("SELECT * FROM user WHERE pwd=%s",(i_dialog))
                    row = cursor.fetchone()
                    if row == None:
        ...
        self.u_id_label= customtkinter.CTkLabel(frame_7, text="ID:")
        self.u_name_label= customtkinter.CTkLabel(frame_7, text="Name:")
        self.u_phone_label = customtkinter.CTkLabel(frame_7, text="Phone Number:",anchor=W)
        ...
        self.u_id= customtkinter.CTkEntry(frame_7, placeholder_text="ID",width=200,height=35)
        self.u_name= customtkinter.CTkEntry(frame_7, placeholder_text="Name",width=200,height=35)
        self.u_phone= customtkinter.CTkEntry(frame_7, placeholder_text="Phone Number",width=200,height=35)
        self.u_usernae= customtkinter.CTkEntry(frame_7, placeholder_text="Username",width=200,height=35)
        self.u_password= customtkinter.CTkEntry(frame_7, placeholder_text="Password",width=200,height=35,show="*")
        ...
        self.u_usernae.grid(row=4,column=1,columnspan=3,padx=5,pady=5)
        self.u_password.grid(row=5,column=1,columnspan=3,padx=5,pady=5)

        self.p_update_button = customtkinter.CTkButton(frame_7,width=50 , text="Change Password", command=button_click_event)
        self.p_update_button.grid(row=7,column=1,columnspan=3,padx=5,pady=4)

        self.p_update_button = customtkinter.CTkButton(frame_7,width=50 , text="Sign Out", command=sign_out_btn)
        ...
        for row in cur:
            ...
            self.u_phone.insert(0, row[2])
            self.u_usernae.insert(0, row[3])
            self.u_password.insert(0, row[4])
        
        self.u_id.configure(state="disabled") 
        self.u_name.configure(state="disabled") 
        self.u_phone.configure(state="disabled") 
        self.u_usernae.configure(state="disabled") 
        self.u_password.configure(state="disabled") 
